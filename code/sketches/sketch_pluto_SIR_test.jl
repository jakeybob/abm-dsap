...
# ╔═╡ 856d10c0-3840-11ed-038f-99943a9b5565
using Agents, Random, DataFrames, Distributions, DrWatson, StatsPlots

# ╔═╡ 80e216a9-9ebe-408a-9522-4fa2ef50e04a
function rate_to_proportion(r::Float64, t::Float64)
    1 - exp(-r*t)
end

# ╔═╡ 0168fd9f-c85f-4846-9ef9-f9cd0543f533
...
# ╔═╡ cd714f86-c7c6-486e-8bff-d6fda7ed8805
begin
	δt = 0.1
	nsteps = 400
	tf = nsteps * δt
...
# ╔═╡ a2cebbe9-7920-48b2-9385-5e7e904a1ff9
# N = 1000 # total agents

# ╔═╡ a3118f30-1879-4d77-83ef-c4427687be40
@bind N html"<input type=range max=1000 min=10 step=5>"

# ╔═╡ db717ad5-3f23-4b45-aaee-8e6b5ae74782
begin
...
# ╔═╡ d50655bd-fa59-4143-8ba5-e7bdaa32f092
@bind β html"<input type=range max=0.99 min=0.01 step=0.1>"

# ╔═╡ 3ea2362a-9bbf-49e5-9254-9c0a35998e7a
@bind c html"<input type=range max=1 min=0 step=0.1>"

# ╔═╡ 2b4b2d65-f708-48cf-9da3-dd802bbe89d6
begin
...
# ╔═╡ 64b5ef5b-333c-4c14-b584-4c28cca18196
begin
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "c33f5e5596d91e6e546364f33580ed644befd72e"
...
git-tree-sha1 = "3e469ffd669639ab2b15963d5ceb4cdfab4838b3"
